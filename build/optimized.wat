(module
 ...
 (import "main" "sayHello" (func $assembly/main/sayHello))
 (memory $0 1)
 ...
 (data (i32.const 288) "\08\00\00\00\01\00\00\00\01\00\00\00\08\00\00\00p\00r\00o\00p")
 (data (i32.const 320) "\16\00\00\00\01\00\00\00\01\00\00\00\16\00\00\00h\00e\00l\00l\00o\00 \00w\00o\00r\00l\00d")
 (data (i32.const 368) "\04\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\10\00\00\00\00\00\00\00\98 A")
 ...
 (export "add" (func $assembly/main/add))
 (export "test" (func $assembly/main/test))
 (start $~start)
 ...
 (func $assembly/main/add (; 15 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  local.get $1
  i32.add
 )
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#clear (; 18 ;) (param $0 i32)
  (local $1 i32)
  i32.const 16
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#constructor (; 19 ;) (result i32)
  (local $0 i32)
  i32.const 24
  i32.const 3
  call $~lib/rt/tlsf/__alloc
 ...
 (func $~lib/util/hash/hashStr (; 21 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/util/string/compareImpl (; 22 ;) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  i32.const 304
 ...
 (func $~lib/string/String.__eq (; 23 ;) (param $0 i32) (result i32)
  (local $1 i32)
  local.get $0
  i32.const 304
  i32.eq
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#find (; 24 ;) (param $0 i32) (param $1 i32) (result i32)
  local.get $0
  i32.load
  local.get $1
  local.get $0
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#rehash (; 25 ;) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#set (; 26 ;) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  local.get $0
 ...
 (func $~lib/rt/pure/__visit (; 31 ;) (param $0 i32)
  local.get $0
  i32.const 404
  i32.lt_u
  if
 ...
 (func $~lib/map/Map<~lib/string/String,~lib/string/String>#__visit_impl (; 32 ;) (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.load
 ...
 (func $~lib/rt/__visit_members (; 33 ;) (param $0 i32)
